...
function ModalVerUProfesor ({usuario, cerrar}) {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                           <div>
                            ...
                            <div>
                                ...
                                <input className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-sky-300 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" value="Profesor" disabled readOnly />
                            </div> 
...
export default ModalVerUProfesor;
